...
mixin _$TodoList on _TodoList, Store {
  ...
  ObservableList<Todo> get visibleTodos => (_$visibleTodosComputed ??=
      ...
      .value;
  Computed<bool> _$canRemoveAllCompltedComputed;

  @override
  bool get canRemoveAllComplted => (_$canRemoveAllCompltedComputed ??=
          Computed<bool>(() => super.canRemoveAllComplted,
              name: '_TodoList.canRemoveAllComplted'))
      .value;
...
canRemoveAllComplted: ${canRemoveAllComplted},
